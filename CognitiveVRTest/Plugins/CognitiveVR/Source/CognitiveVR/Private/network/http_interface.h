...
class HttpInterface
{
    ...
    public:
        ...
        virtual std::string Post(std::string url, std::string path, std::string headers[], int32 header_count, std::string content, long timeout, NetworkCallback callback = NULL) = 0;
};
