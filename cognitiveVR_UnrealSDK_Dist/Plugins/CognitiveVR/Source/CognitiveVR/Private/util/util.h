...
namespace cognitivevrapi
{
    class Util
    {
        public:
			...
			//TODO remove this awful trim nonsense
            /*template < typename T >
			...
			//static void AppendToJsonObject(TSharedPtr<FJsonObject> &json, FString &name, std::string &stdstring);
			//static void AppendToJsonObject(TSharedPtr<FJsonObject> &json, FString &name, FString &fstring);
			//static void AppendToJsonObject(TSharedPtr<FJsonObject> &json, FString &name, bool &mybool);
			//static void AppendToJsonObject(TSharedPtr<FJsonObject> &json, FString &name, int32 &intValue);
			//static void AppendToJsonObject(TSharedPtr<FJsonObject> &json, FString &name, double &doubleValue);
