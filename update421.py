...
replaceline(cwd+"/Plugins/CognitiveVR/Source/CognitiveVR/Private/rtaudio/CRtAudio.cpp","#include \"HideWindowsPlatformTypes.h\"","#include \"Windows/HideWindowsPlatformTypes.h\"")
